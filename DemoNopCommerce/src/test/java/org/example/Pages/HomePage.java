...
public class HomePage {
    ...
    public String GetSubCategoryTitle(){
       return Hooks.driver.findElement(By.className("page-title")).getText();
    }
  ...
  public void SuccessMesssageWishList(){
    ...
    public void CheckFirstSlider(){
        ...
        String FirstSlider= Hooks.driver.findElement(By.xpath("/html/body/div[6]/div[3]/div/div/div/div/div[1]/div[1]/a[1]")).getText();
       System.out.println("FirstSlider");
        System.out.println(FirstSlider);
    ...
    public void CheckSecondSlider(){
        ...
        String secondSlider= Hooks.driver.findElement(By.xpath("/html/body/div[6]/div[3]/div/div/div/div/div[1]/div[1]/a[2]")).getText();
        System.out.println("SecondSlider");
        System.out.println(secondSlider);
