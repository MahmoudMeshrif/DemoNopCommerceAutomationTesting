...
public class hoverCategoriesStepDefintion {
    ...
    public void CheckSubCategoryTile() {
       ...
       // String pageTitle = HP.GetSubCategoryTitle();
       String pageTilte2= Hooks.driver.getTitle().toLowerCase().trim();
        System.out.println(pageTilte2);
        Assert.assertTrue(pageTilte2.contains(SubCategoryTitle));
